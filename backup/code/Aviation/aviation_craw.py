...
aviation_path = Path(global_path, 'Aviation')
file_path = Path(aviation_path, 'craw')
out_path = Path(file_path, '生产资料')
out_path_gdp = Path(file_path, 'GDP.csv')
raw_path = Path(aviation_path, 'raw')
